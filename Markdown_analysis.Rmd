...
Knowing where a journey began and ended we can estimate the most likely route taken. For example, a journey from Wetherby to Otley depicted as a straight line can be transformed into a traffic route as seen in the picture below.

```{r pressure, echo=FALSE, fig.cap="Estimation of route taken between Wetherby and Otley", out.width = '100%'}
knitr::include_graphics("maps\\Example_line2route.png")
```
